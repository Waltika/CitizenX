...
import { copyFile, mkdir, rm, rename, readFile, writeFile, cp } from 'fs/promises'; // Add 'cp'
...
async function buildChromeExtension() {
        ...
        build: {
            ...
            rollupOptions: {
                ...
                output: {
                    ...
                    chunkFileNames: 'assets/[name]-[hash].js', // Support code-splitting
                    assetFileNames: 'assets/[name]-[hash].[ext]',
                    format: 'es', // Use 'es' to support code-splitting
    ...
    // Copy any additional chunks generated by code-splitting
    if (existsSync(resolve(tempSidepanelDir, 'assets'))) {
        await cp(
            resolve(tempSidepanelDir, 'assets'),
            resolve(chromeExtensionDir, 'sidepanel/assets'),
            { recursive: true }
        );
    }
